...
def main(args):
    ...
    with torch.no_grad():
            prompts_pos,prompts_neg = prompt_learner()  # 调用forward函数生成融合后的tg
    
        # 5. 打印结果
    #print("pp形状:", prompts_pos.shape)
    print("示例值:", prompts_pos[0])  # 打印第一个类别、第一个状态模板的前5个token的前5维
    #print("pn形状:", prompts_neg.shape)
    print("示例值:", prompts_neg[0])
